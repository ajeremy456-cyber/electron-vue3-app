...
const _hoisted_1$2 = { class: "grid grid-cols-1 md:grid-cols-3 gap-6" };
const _hoisted_2$2 = { class: "bg-white rounded-xl shadow-sm p-6 border border-gray-200" };
const _hoisted_3$2 = { class: "text-2xl font-bold text-gray-800" };
const _hoisted_4$2 = { class: "bg-white rounded-xl shadow-sm p-6 border border-gray-200" };
const _hoisted_5$2 = { class: "text-2xl font-bold text-gray-800" };
const _hoisted_6$2 = { class: "bg-white rounded-xl shadow-sm p-6 border border-gray-200" };
const _hoisted_7$2 = { class: "text-3xl mb-2" };
const _hoisted_8$2 = { class: "text-2xl font-bold text-gray-800" };
const _hoisted_9$2 = { class: "mt-8 bg-white rounded-xl shadow-sm p-6 border border-gray-200" };
const _hoisted_10$2 = { class: "space-y-3" };
const _hoisted_11$2 = { class: "flex justify-between items-center" };
const _hoisted_12$2 = { class: "font-medium" };
const _hoisted_13$1 = { class: "flex justify-between items-center" };
const _hoisted_14$1 = { class: "font-medium" };
const _hoisted_15$1 = { class: "flex justify-between items-center" };
const _hoisted_16$1 = { class: "font-medium" };
const _sfc_main$2 = {
  __name: "Dashboard",
  setup(__props) {
      ...
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", _hoisted_1$2, [
          createBaseVNode("div", _hoisted_2$2, [
            _cache[0] || (_cache[0] = createBaseVNode("div", { class: "text-3xl mb-2" }, "📺", -1)),
            createBaseVNode("div", _hoisted_3$2, toDisplayString(unref(chatStore).messageCount), 1),
            _cache[1] || (_cache[1] = createBaseVNode("div", { class: "text-gray-500 text-sm" }, "收到的訊息", -1))
          ]),
          createBaseVNode("div", _hoisted_4$2, [
            _cache[2] || (_cache[2] = createBaseVNode("div", { class: "text-3xl mb-2" }, "💬", -1)),
            createBaseVNode("div", _hoisted_5$2, toDisplayString(unref(chatStore).currentRoom || "-"), 1),
            _cache[3] || (_cache[3] = createBaseVNode("div", { class: "text-gray-500 text-sm" }, "目前直播間", -1))
          ]),
          createBaseVNode("div", _hoisted_6$2, [
            createBaseVNode("div", _hoisted_7$2, toDisplayString(unref(chatStore).isConnected ? "🟢" : "⚪"), 1),
            createBaseVNode("div", _hoisted_8$2, toDisplayString(unref(chatStore).isConnected ? "已連接" : "未連接"), 1),
            _cache[4] || (_cache[4] = createBaseVNode("div", { class: "text-gray-500 text-sm" }, "連線狀態", -1))
          ])
        ]),
        createBaseVNode("div", _hoisted_9$2, [
          _cache[9] || (_cache[9] = createBaseVNode("h3", { class: "text-lg font-semibold mb-4" }, "系統資訊", -1)),
          createBaseVNode("div", _hoisted_10$2, [
            ...
            createBaseVNode("div", _hoisted_11$2, [
              _cache[5] || (_cache[5] = createBaseVNode("span", { class: "text-gray-600" }, "Electron 版本", -1)),
              createBaseVNode("span", _hoisted_12$2, toDisplayString(unref(versions).electron || "N/A"), 1)
            ]),
            createBaseVNode("div", _hoisted_13$1, [
              _cache[6] || (_cache[6] = createBaseVNode("span", { class: "text-gray-600" }, "Node 版本", -1)),
              createBaseVNode("span", _hoisted_14$1, toDisplayString(unref(versions).node || "N/A"), 1)
            ]),
            createBaseVNode("div", _hoisted_15$1, [
              _cache[7] || (_cache[7] = createBaseVNode("span", { class: "text-gray-600" }, "平台", -1)),
              createBaseVNode("span", _hoisted_16$1, toDisplayString(unref(platform)), 1)
            ])
          ])
        ]),
        _cache[10] || (_cache[10] = createBaseVNode("div", { class: "mt-8 bg-blue-50 rounded-xl shadow-sm p-6 border border-blue-100" }, [
