...
const _hoisted_1$3 = { class: "flex h-screen bg-gray-100" };
const _hoisted_2$3 = { class: "w-64 bg-gray-900 text-white flex flex-col" };
const _hoisted_3$3 = { class: "flex-1 py-4" };
const _hoisted_4$3 = { class: "text-lg" };
const _hoisted_5$3 = { class: "font-medium" };
const _hoisted_6$3 = { class: "p-4 border-t border-gray-700 text-xs text-gray-500" };
const _hoisted_7$3 = { class: "flex-1 flex flex-col overflow-hidden" };
const _hoisted_8$3 = { class: "h-16 bg-white border-b flex items-center px-6 shadow-sm" };
const _hoisted_9$3 = { class: "text-lg font-semibold text-gray-700" };
const _hoisted_10$3 = { class: "flex-1 overflow-auto p-6" };
const _sfc_main$3 = {
  __name: "App",
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("aside", _hoisted_2$3, [
          _cache[0] || (_cache[0] = createBaseVNode("div", { class: "h-16 flex items-center px-6 border-b border-gray-700" }, [
            createBaseVNode("h1", { class: "text-xl font-bold" }, "📺 TikTok Live")
          ], -1)),
          createBaseVNode("nav", _hoisted_3$3, [
            (openBlock(), createElementBlock(Fragment, null, renderList(navItems, (item) => {
              return createVNode(_component_RouterLink, {
                key: item.path,
                to: item.path,
                class: normalizeClass(["flex items-center gap-3 px-6 py-3 mx-2 rounded-lg transition-colors", isActive(item.path) ? "bg-blue-600 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white"])
              }, {
                default: withCtx(() => [
                  createBaseVNode("span", _hoisted_4$3, toDisplayString(item.icon), 1),
                  createBaseVNode("span", _hoisted_5$3, toDisplayString(item.name), 1)
                ]),
                _: 2
              }, 1032, ["to", "class"]);
            }), 64))
          ...
          createBaseVNode("div", _hoisted_6$3, [
            createBaseVNode("div", null, "Electron " + toDisplayString(unref(versions).electron), 1),
            createBaseVNode("div", null, "Node " + toDisplayString(unref(versions).node), 1)
          ])
        ]),
        createBaseVNode("main", _hoisted_7$3, [
          createBaseVNode("header", _hoisted_8$3, [
            createBaseVNode("h2", _hoisted_9$3, toDisplayString(currentPageName.value), 1)
          ]),
...
const useChatStore = /* @__PURE__ */ defineStore("chat", () => {
  ...
  const currentRoom = /* @__PURE__ */ ref("");
  ...
  const addMessage = (msg) => {
    const entry = {
      ...
      text: msg.text,
      time: msg.time || (/* @__PURE__ */ new Date()).toLocaleTimeString()
    };
...
const _hoisted_1$2 = {
  key: 0,
  class: "mb-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl shadow-sm p-6 text-white"
};
const _hoisted_2$2 = { class: "flex items-center justify-between" };
const _hoisted_3$2 = { class: "text-4xl font-bold mt-1" };
const _hoisted_4$2 = { class: "text-sm opacity-80 mt-1" };
const _hoisted_5$2 = { class: "mt-3 bg-white/20 rounded-full h-2" };
const _hoisted_6$2 = { class: "grid grid-cols-1 md:grid-cols-3 gap-6" };
const _hoisted_7$2 = { class: "bg-white rounded-xl shadow-sm p-6 border border-gray-200" };
const _hoisted_8$2 = { class: "text-2xl font-bold text-gray-800" };
const _hoisted_9$2 = { class: "bg-white rounded-xl shadow-sm p-6 border border-gray-200" };
const _hoisted_10$2 = { class: "text-2xl font-bold text-gray-800" };
const _hoisted_11$2 = { class: "bg-white rounded-xl shadow-sm p-6 border border-gray-200" };
const _hoisted_12$2 = { class: "text-3xl mb-2" };
const _hoisted_13$1 = { class: "text-2xl font-bold text-gray-800" };
const _hoisted_14$1 = { class: "mt-8 bg-white rounded-xl shadow-sm p-6 border border-gray-200" };
const _hoisted_15$1 = { class: "space-y-3" };
const _hoisted_16$1 = { class: "flex justify-between items-center" };
const _hoisted_17$1 = { class: "font-medium" };
const _hoisted_18$1 = { class: "flex justify-between items-center" };
const _hoisted_19$1 = { class: "font-medium" };
const _hoisted_20$1 = { class: "flex justify-between items-center" };
const _hoisted_21$1 = { class: "font-medium" };
const _sfc_main$2 = {
  __name: "Dashboard",
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        exp.value ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
          createBaseVNode("div", _hoisted_2$2, [
            createBaseVNode("div", null, [
              _cache[1] || (_cache[1] = createBaseVNode("div", { class: "text-sm opacity-80" }, "試用版剩餘天數", -1)),
              createBaseVNode("div", _hoisted_3$2, [
                createTextVNode(toDisplayString(exp.value.remaining) + " ", 1),
                _cache[0] || (_cache[0] = createBaseVNode("span", { class: "text-lg font-normal opacity-80" }, "天", -1))
              ]),
              createBaseVNode("div", _hoisted_4$2, "已使用 " + toDisplayString(exp.value.elapsed) + " / " + toDisplayString(exp.value.totalDays) + " 天", 1)
            ]),
            _cache[2] || (_cache[2] = createBaseVNode("div", { class: "text-6xl" }, "⏱️", -1))
          ]),
          createBaseVNode("div", _hoisted_5$2, [
            createBaseVNode("div", {
              class: "bg-white rounded-full h-2 transition-all",
              style: normalizeStyle({ width: Math.max(0, exp.value.remaining / exp.value.totalDays * 100) + "%" })
            }, null, 4)
          ]),
          _cache[3] || (_cache[3] = createBaseVNode("div", { class: "text-xs opacity-80 mt-2" }, "試用期 14 天，過期後程式將無法啟動", -1))
        ])) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_6$2, [
          createBaseVNode("div", _hoisted_7$2, [
            _cache[4] || (_cache[4] = createBaseVNode("div", { class: "text-3xl mb-2" }, "📺", -1)),
            createBaseVNode("div", _hoisted_8$2, toDisplayString(unref(chatStore).messageCount), 1),
            _cache[5] || (_cache[5] = createBaseVNode("div", { class: "text-gray-500 text-sm" }, "收到的訊息", -1))
          ]),
          createBaseVNode("div", _hoisted_9$2, [
            _cache[6] || (_cache[6] = createBaseVNode("div", { class: "text-3xl mb-2" }, "💬", -1)),
            createBaseVNode("div", _hoisted_10$2, toDisplayString(unref(chatStore).currentRoom || "-"), 1),
            _cache[7] || (_cache[7] = createBaseVNode("div", { class: "text-gray-500 text-sm" }, "目前直播間", -1))
          ]),
          createBaseVNode("div", _hoisted_11$2, [
            createBaseVNode("div", _hoisted_12$2, toDisplayString(unref(chatStore).isConnected ? "🟢" : "⚪"), 1),
            createBaseVNode("div", _hoisted_13$1, toDisplayString(unref(chatStore).isConnected ? "已連接" : "未連接"), 1),
            _cache[8] || (_cache[8] = createBaseVNode("div", { class: "text-gray-500 text-sm" }, "連線狀態", -1))
          ])
        ]),
        createBaseVNode("div", _hoisted_14$1, [
          _cache[13] || (_cache[13] = createBaseVNode("h3", { class: "text-lg font-semibold mb-4" }, "系統資訊", -1)),
          createBaseVNode("div", _hoisted_15$1, [
            _cache[12] || (_cache[12] = createBaseVNode("div", { class: "flex justify-between items-center" }, [
              createBaseVNode("span", { class: "text-gray-600" }, "應用程式版本"),
              createBaseVNode("span", { class: "font-medium" }, "v1.0.0")
            ], -1)),
            createBaseVNode("div", _hoisted_16$1, [
              _cache[9] || (_cache[9] = createBaseVNode("span", { class: "text-gray-600" }, "Electron 版本", -1)),
              createBaseVNode("span", _hoisted_17$1, toDisplayString(unref(versions).electron || "N/A"), 1)
            ]),
            createBaseVNode("div", _hoisted_18$1, [
              _cache[10] || (_cache[10] = createBaseVNode("span", { class: "text-gray-600" }, "Node 版本", -1)),
              createBaseVNode("span", _hoisted_19$1, toDisplayString(unref(versions).node || "N/A"), 1)
            ]),
            createBaseVNode("div", _hoisted_20$1, [
              _cache[11] || (_cache[11] = createBaseVNode("span", { class: "text-gray-600" }, "平台", -1)),
              createBaseVNode("span", _hoisted_21$1, toDisplayString(unref(platform)), 1)
            ])
          ])
        ]),
        _cache[14] || (_cache[14] = createBaseVNode("div", { class: "mt-8 bg-blue-50 rounded-xl shadow-sm p-6 border border-blue-100" }, [
          createBaseVNode("h3", { class: "text-lg font-semibold mb-2 text-blue-800" }, "💡 使用說明"),
          createBaseVNode("ol", { class: "text-sm text-blue-700 space-y-1 list-decimal list-inside" }, [
            createBaseVNode("li", null, [
              createTextVNode("到 "),
              createBaseVNode("strong", null, "LiveChat"),
              createTextVNode(" 頁面")
            ]),
            createBaseVNode("li", null, "輸入 TikTok 直播間帳號（例：t7vomg9）"),
            createBaseVNode("li", null, [
              createTextVNode("點擊 "),
              createBaseVNode("strong", null, "連接"),
              createTextVNode(" 按鈕")
            ]),
            createBaseVNode("li", null, "開始接收直播間的即時留言、禮物、成員進場訊息")
          ])
        ], -1))
      ]);
    };
...
const _hoisted_1$1 = { class: "bg-white rounded-xl shadow-sm border border-gray-200 h-full flex flex-col" };
const _hoisted_2$1 = { class: "p-4 border-b border-gray-200 flex gap-3" };
...
const _hoisted_6$1 = { class: "text-lg flex-shrink-0 w-6 text-center" };
const _hoisted_7$1 = { class: "flex-1 min-w-0" };
const _hoisted_8$1 = { class: "flex items-center gap-2 flex-wrap" };
const _hoisted_9$1 = { class: "text-gray-400 text-xs" };
const _hoisted_10$1 = { class: "text-gray-800 text-sm break-words" };
const _hoisted_11$1 = { class: "p-3 border-t border-gray-200 bg-gray-50 text-sm flex justify-between" };
const _hoisted_12$1 = { class: "text-gray-500" };
const _sfc_main$1 = {
  __name: "LiveChat",
  setup(__props) {
    const chatStore = useChatStore();
    const roomId = /* @__PURE__ */ ref("");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          withDirectives(createBaseVNode("input", {
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => roomId.value = $event),
            type: "text",
            placeholder: "輸入直播間用戶名...",
            class: "flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",
            disabled: unref(chatStore).isConnected,
            onKeyup: withKeys(handleConnect, ["enter"])
          }, null, 40, _hoisted_3$1), [
            [vModelText, roomId.value]
          ]),
          createBaseVNode("button", {
            onClick: handleConnect,
            disabled: unref(chatStore).isConnected || !roomId.value.trim(),
            class: "px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50"
          }, toDisplayString(unref(chatStore).isConnected ? "已連接" : "連接"), 9, _hoisted_4$1),
          unref(chatStore).isConnected ? (openBlock(), createElementBlock("button", {
            key: 0,
            onClick: handleDisconnect,
            class: "px-6 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600"
          }, " 中斷 ")) : createCommentVNode("", true)
        ]),
        createBaseVNode("div", {
          ...
          unref(chatStore).messages.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_5$1, " 尚無留言，連接直播間後開始接收訊息 ")) : createCommentVNode("", true),
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(chatStore).messages, (msg) => {
            return openBlock(), createElementBlock("div", {
              key: msg.id,
              class: normalizeClass(["flex gap-3 py-1.5 px-2 rounded hover:bg-gray-50", msg.type === "system" ? "bg-blue-50 border border-blue-100" : ""])
            }, [
              createBaseVNode("span", _hoisted_6$1, toDisplayString(getIcon(msg.type)), 1),
              createBaseVNode("div", _hoisted_7$1, [
                createBaseVNode("div", _hoisted_8$1, [
                  createBaseVNode("span", {
                    class: normalizeClass(["font-semibold text-blue-600", msg.type === "system" ? "text-blue-500" : ""])
                  }, toDisplayString(msg.nickname), 3),
                  createBaseVNode("span", _hoisted_9$1, toDisplayString(msg.time), 1)
                ]),
                createBaseVNode("div", _hoisted_10$1, toDisplayString(msg.text), 1)
              ])
            ], 2);
          }), 128))
        ], 512),
        createBaseVNode("div", _hoisted_11$1, [
          createBaseVNode("span", {
            class: normalizeClass(unref(chatStore).isConnected ? "text-green-600" : "text-gray-400")
          }, toDisplayString(unref(chatStore).isConnected ? "🟢 已連接到 @" + unref(chatStore).currentRoom : "⚪ 未連接"), 3),
          createBaseVNode("span", _hoisted_12$1, "共 " + toDisplayString(unref(chatStore).messageCount) + " 條訊息", 1)
        ])
      ]);
    };
  }
...
class DatabaseService {
  ...
  // Blacklist
  async getBlacklist() {
    return await window.db.getBlacklist();
  }
  async addToBlacklist(nickname, reason = "") {
    return await window.db.addToBlacklist(nickname, reason);
  }
  async removeFromBlacklist(id) {
    return await window.db.removeFromBlacklist(id);
  }
  async clearBlacklist() {
    return await window.db.clearBlacklist();
  }
  async exportBlacklist() {
    return await window.db.exportBlacklist();
  }
}
const databaseService = new DatabaseService();
const useRulesStore = /* @__PURE__ */ defineStore("rules", () => {
...
function SSF_write_date(type, fmt, val, ss0) {
  var o = "", ss = 0, tt2 = 0, y = val.y, out, outl = 0;
  switch (type) {
    case 98:
      y = val.y + 543;
    /* falls through */
...
const useOrdersStore = /* @__PURE__ */ defineStore("orders", () => {
  ...
  const exportOrders = async () => {
    const data = await databaseService.getOrders(1e4);
    if (data.length === 0) {
      alert("尚無訂單資料");
      return;
    }
    ...
    utils.book_append_sheet(wb, ws, "準訂單");
    writeFileSync(wb, `orders_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`);
  };
  return {
    orders,
    loading,
...
const _hoisted_3 = { class: "flex items-center justify-between mb-5" };
const _hoisted_4 = { class: "text-xs bg-red-100 text-red-700 px-2 py-1 rounded-full" };
const _hoisted_5 = { class: "flex gap-2 mb-5" };
...
const _hoisted_15 = { class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6" };
const _hoisted_16 = { class: "flex items-center justify-between mb-5" };
const _hoisted_17 = { class: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full" };
const _hoisted_18 = { class: "flex gap-2 mb-5" };
...
const _hoisted_23 = { class: "flex-shrink-0 min-w-[120px]" };
const _hoisted_24 = { class: "font-semibold text-blue-600" };
...
const _hoisted_28 = { class: "text-xs px-2 py-0.5 rounded bg-gray-200 text-gray-600 flex-shrink-0" };
const _hoisted_29 = ["onClick"];
const _hoisted_30 = { class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6" };
const _hoisted_31 = { class: "flex items-center justify-between mb-4" };
const _hoisted_32 = { class: "flex gap-2" };
const _hoisted_33 = { class: "overflow-x-auto" };
const _hoisted_34 = { class: "w-full text-sm" };
const _hoisted_35 = { key: 0 };
const _hoisted_36 = { class: "py-2 text-gray-500" };
const _hoisted_37 = { class: "py-2" };
const _hoisted_38 = { class: "bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-xs font-medium" };
const _hoisted_39 = { class: "py-2 font-medium text-gray-800" };
const _hoisted_40 = { class: "py-2 text-gray-600 max-w-xs truncate" };
const _hoisted_41 = { class: "py-2" };
const _hoisted_42 = ["onClick"];
const _hoisted_43 = { class: "mt-2 text-xs text-gray-400 text-right" };
const _hoisted_44 = { class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6" };
const _hoisted_45 = { class: "flex gap-3" };
const _sfc_main = {
  __name: "Settings",
  setup(__props) {
    const rulesStore = useRulesStore();
    const ordersStore = useOrdersStore();
    const blacklist = /* @__PURE__ */ ref([]);
    const newBlackNick = /* @__PURE__ */ ref("");
    const newBlackReason = /* @__PURE__ */ ref("");
    const newKeyword = /* @__PURE__ */ ref("");
    const newAutoReply = /* @__PURE__ */ ref("");
    const newAction = /* @__PURE__ */ ref("order");
    onMounted(async () => {
      await loadBlacklist();
    ...
    const exportBlack = async () => {
      ...
      const ws = utils.aoa_to_sheet(wsData);
      const wb = utils.book_new();
      utils.book_append_sheet(wb, ws, "黑名單");
      writeFileSync(wb, `blacklist_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`);
    };
    const addRule = async () => {
    ...
    const exportMessages = async () => {
      const data = await databaseService.getMessages(1e4);
      if (data.length === 0) {
        alert("尚無訊息資料");
        return;
      }
      ...
      const ws = utils.aoa_to_sheet(wsData);
      const wb = utils.book_new();
      utils.book_append_sheet(wb, ws, "訊息記錄");
      writeFileSync(wb, `messages_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`);
    };
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            _cache[9] || (_cache[9] = createBaseVNode("div", null, [
              createBaseVNode("h2", { class: "text-lg font-semibold text-gray-800" }, "🚫 黑名單"),
              createBaseVNode("p", { class: "text-sm text-gray-500 mt-1" }, "黑名單用戶的訊息不會顯示，也不會觸發訂單")
            ], -1)),
            createBaseVNode("span", _hoisted_4, toDisplayString(blacklist.value.length) + " 人 ", 1)
          ]),
          createBaseVNode("div", _hoisted_5, [
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => newBlackNick.value = $event),
              type: "text",
              placeholder: "用戶暱稱",
              class: "flex-1 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-sm",
              onKeyup: withKeys(addBlack, ["enter"])
            }, null, 544), [
              [vModelText, newBlackNick.value]
            ]),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => newBlackReason.value = $event),
              type: "text",
              placeholder: "原因（可選）",
              class: "flex-1 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-sm",
              onKeyup: withKeys(addBlack, ["enter"])
            }, null, 544), [
              [vModelText, newBlackReason.value]
            ]),
            createBaseVNode("button", {
              onClick: addBlack,
              disabled: !newBlackNick.value.trim(),
              class: "px-5 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 text-sm font-medium"
            }, " 加入 ", 8, _hoisted_6)
          ]),
          createBaseVNode("div", _hoisted_7, [
            blacklist.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_8, " 黑名單是空的 ")) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(blacklist.value, (user) => {
              return openBlock(), createElementBlock("div", {
                key: user.id,
                class: "flex items-center gap-3 p-3 rounded-lg border border-gray-100 bg-gray-50"
              }, [
                _cache[10] || (_cache[10] = createBaseVNode("span", { class: "text-red-400 text-lg" }, "🚫", -1)),
                createBaseVNode("div", _hoisted_9, [
                  createBaseVNode("span", _hoisted_10, toDisplayString(user.nickname), 1),
                  user.reason ? (openBlock(), createElementBlock("span", _hoisted_11, toDisplayString(user.reason), 1)) : createCommentVNode("", true)
                ]),
                createBaseVNode("span", _hoisted_12, toDisplayString(user.created_at?.slice(0, 10)), 1),
                createBaseVNode("button", {
                  onClick: ($event) => removeBlack(user.id),
                  class: "text-red-400 hover:text-red-600 text-sm"
                }, " 移除 ", 8, _hoisted_13)
              ]);
            }), 128))
          ]),
          blacklist.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_14, [
            createBaseVNode("button", {
              onClick: exportBlack,
        ...
        createBaseVNode("div", _hoisted_15, [
          createBaseVNode("div", _hoisted_16, [
            _cache[11] || (_cache[11] = createBaseVNode("div", null, [
              createBaseVNode("h2", { class: "text-lg font-semibold text-gray-800" }, "💬 關鍵字規則"),
              createBaseVNode("p", { class: "text-sm text-gray-500 mt-1" }, "訊息包含關鍵字時自動列入準訂單")
            ], -1)),
            createBaseVNode("span", _hoisted_17, toDisplayString(unref(rulesStore).rules.length) + " 條規則 ", 1)
          ]),
          createBaseVNode("div", _hoisted_18, [
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => newKeyword.value = $event),
              type: "text",
              ...
              onKeyup: withKeys(addRule, ["enter"])
            }, null, 544), [
              [vModelText, newKeyword.value]
            ]),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => newAutoReply.value = $event),
              type: "text",
              placeholder: "自動回覆（可選）",
              class: "flex-1 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm",
              onKeyup: withKeys(addRule, ["enter"])
            }, null, 544), [
              [vModelText, newAutoReply.value]
            ]),
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => newAction.value = $event),
              class: "px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
            }, [..._cache[12] || (_cache[12] = [
              createBaseVNode("option", { value: "order" }, "列入訂單", -1),
              createBaseVNode("option", { value: "reply" }, "自動回覆", -1),
              createBaseVNode("option", { value: "both" }, "兩者皆執行", -1)
            ])], 512), [
              [vModelSelect, newAction.value]
            ]),
            createBaseVNode("button", {
              onClick: addRule,
              disabled: !newKeyword.value.trim(),
              class: "px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 text-sm font-medium"
            }, " 新增 ", 8, _hoisted_19)
          ]),
          createBaseVNode("div", _hoisted_20, [
            unref(rulesStore).rules.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_21, " 尚無關鍵字規則 ")) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(rulesStore).rules, (rule) => {
              return openBlock(), createElementBlock("div", {
                key: rule.id,
                class: "flex items-center gap-3 p-3 rounded-lg border border-gray-100 hover:border-gray-200 bg-gray-50"
              }, [
                createBaseVNode("button", {
                  onClick: ($event) => toggleRule(rule),
                  class: normalizeClass(["flex-shrink-0 w-10 h-6 rounded-full transition-colors", rule.enabled ? "bg-green-500" : "bg-gray-300"])
                }, [
                  createBaseVNode("div", {
                    class: normalizeClass(["w-4 h-4 bg-white rounded-full shadow transform transition-transform mt-1", rule.enabled ? "translate-x-5" : "translate-x-1"])
                  }, null, 2)
                ], 10, _hoisted_22),
                createBaseVNode("div", _hoisted_23, [
                  createBaseVNode("span", _hoisted_24, "「" + toDisplayString(rule.keyword) + "」", 1)
                ]),
                createBaseVNode("div", _hoisted_25, [
                  rule.auto_reply ? (openBlock(), createElementBlock("span", _hoisted_26, " 回覆：" + toDisplayString(rule.auto_reply), 1)) : (openBlock(), createElementBlock("span", _hoisted_27, "無自動回覆"))
                ]),
                createBaseVNode("span", _hoisted_28, toDisplayString(actionLabel(rule.action)), 1),
                createBaseVNode("button", {
        ...
        createBaseVNode("div", _hoisted_30, [
          createBaseVNode("div", _hoisted_31, [
            _cache[13] || (_cache[13] = createBaseVNode("div", null, [
              createBaseVNode("h2", { class: "text-lg font-semibold text-gray-800" }, "📦 準訂單明細"),
              createBaseVNode("p", { class: "text-sm text-gray-500 mt-1" }, "被關鍵字觸發的訊息自動列入這裡")
            ], -1)),
            createBaseVNode("div", _hoisted_32, [
              createBaseVNode("button", {
                onClick: _cache[5] || (_cache[5] = ($event) => unref(ordersStore).fetchOrders()),
                class: "px-4 py-2 text-sm bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200"
              }, " 重新整理 "),
              createBaseVNode("button", {
                onClick: _cache[6] || (_cache[6] = ($event) => unref(ordersStore).exportOrders()),
                class: "px-4 py-2 text-sm bg-green-600 text-white rounded-lg hover:bg-green-700"
              }, " 匯出 Excel "),
              createBaseVNode("button", {
                onClick: _cache[7] || (_cache[7] = ($event) => unref(ordersStore).clearOrders()),
                class: "px-4 py-2 text-sm bg-red-50 text-red-600 rounded-lg hover:bg-red-100"
              }, " 清除全部 ")
            ])
          ]),
            ...
            createBaseVNode("table", _hoisted_34, [
              _cache[15] || (_cache[15] = createBaseVNode("thead", null, [
                createBaseVNode("tr", { class: "text-left text-gray-500 border-b" }, [
                  createBaseVNode("th", { class: "pb-2 font-medium" }, "時間"),
                  createBaseVNode("th", { class: "pb-2 font-medium" }, "觸發關鍵字"),
                  createBaseVNode("th", { class: "pb-2 font-medium" }, "用戶"),
                  createBaseVNode("th", { class: "pb-2 font-medium" }, "內容"),
                  createBaseVNode("th", { class: "pb-2 font-medium" })
                ])
              ], -1)),
              createBaseVNode("tbody", null, [
                unref(ordersStore).orders.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_35, [..._cache[14] || (_cache[14] = [
                  createBaseVNode("td", {
                    colspan: "5",
                    class: "py-6 text-center text-gray-400"
                  }, "尚無訂單記錄", -1)
                ])])) : createCommentVNode("", true),
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(ordersStore).orders, (order) => {
                  return openBlock(), createElementBlock("tr", {
                    key: order.id,
                    class: "border-b border-gray-50 hover:bg-gray-50"
                  }, [
                    createBaseVNode("td", _hoisted_36, toDisplayString(order.triggered_at), 1),
                    createBaseVNode("td", _hoisted_37, [
                      createBaseVNode("span", _hoisted_38, toDisplayString(order.keyword), 1)
                    ]),
                    createBaseVNode("td", _hoisted_39, toDisplayString(order.nickname), 1),
                    createBaseVNode("td", _hoisted_40, toDisplayString(order.text), 1),
                    createBaseVNode("td", _hoisted_41, [
                      createBaseVNode("button", {
                        onClick: ($event) => unref(ordersStore).deleteOrder(order.id),
          ...
          createBaseVNode("div", _hoisted_43, " 共 " + toDisplayString(unref(ordersStore).orders.length) + " 筆 ", 1)
        ]),
        createBaseVNode("div", _hoisted_44, [
          _cache[16] || (_cache[16] = createBaseVNode("h2", { class: "text-lg font-semibold text-gray-800 mb-4" }, "📊 訊息管理", -1)),
          createBaseVNode("div", _hoisted_45, [
            createBaseVNode("button", {
              onClick: _cache[8] || (_cache[8] = ($event) => unref(ordersStore).fetchOrders()),
...
const routes = [
  { path: "/", name: "Dashboard", component: _sfc_main$2 },
  { path: "/livechat", name: "LiveChat", component: _sfc_main$1 },
  { path: "/settings", name: "Settings", component: _sfc_main }
];
